...
first_stage_start_time <- Sys.time()
...
first_stage_end_time <- Sys.time()
runtime <- as.numeric(difftime(
  first_stage_end_time, first_stage_start_time, units = 'hours'
))
log_info(sprintf('First stage runtime: %.2f hours', runtime))
